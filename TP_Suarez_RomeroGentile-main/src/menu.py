    ...
    def mostrar_menu(self):
        ...
        while i == 0:
                ...
                if (eleccion == "1"):
                    ...
                    while l==0:
                        try:
                            telefono = int(input('Ingrese el telefono del paciente, con el codigo de area (Ejemplo: 1123456789): '))
                    ...
                    l=0
                    while l==0:
                        sangre = str(input('Ingrese el tipo de sangre del paciente, en mayusculas (Ejemplo: 0+): '))
                        ...
                        while l == 0:
                            try:
                                ...
                                if opcion == '1':
                                    ...
                                    while l==0:
                                            try:
                                                espera = int(input('Ingrese la fecha de nacimiento del paciente (Ejemplo: 17052025, si nacio el 17/05/2025): '))
                                                if (7>len(str(espera)) or len(str(espera))<8 or espera<0 or espera > 31122025):
                                                    print('Ingrese su respuesta en el formato correcto.')
                                                else:
                                                    l = 1
                                            except ValueError:
